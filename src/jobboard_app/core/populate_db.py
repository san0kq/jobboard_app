...
cursor.execute(
    ...
    "city_id, "
    "company_id) VALUES "
    "('John', 'Cook', 'Cookjohn@gmail.com', '803326663', 'qwerty', 5, 1), "
    "('Alex', 'Kiganov', 'Kiganov@mail.ru', '+37566772233', 'qwerty', 4, 2);"
)
conn.commit()
cursor.execute(
    ...
    "salary_id, "
    "years_exp) VALUES "
    "('Python Developer', 'Description', 1, 1, 1, 1), "
    "('Java Developer', 'Description', 2, 2, 2, 2);"
)
conn.commit()
cursor.execute(
    "INSERT INTO core_review (text, company_id, user_id) VALUES "
    "('Random text', 1, 1), ('Random text', 2, 1);"
)
cursor.execute(
    "INSERT INTO core_reviewrating (rating_id, review_id, user_id) VALUES "
    "(1, 1, 1), (2, 2, 1);"
)
cursor.execute(
...
cursor.execute(
    ...
    "user_id, "
    "vacancy_id) VALUES "
    "('Random text', '8033233366', 4, 1, 1), "
    "('Random text', '8023332233', 5, 1, 2);"
)
cursor.execute(
